    ...
    <section class="argument-illustration container">
        <!-- Vérifier picture src img -->
        <picture>
            <img srcset="/images/detail/mobile/image-insure-hero.jpg,
                        /images/detail/mobile/image-insure-hero@2x.jpg,
                        /images/detail/tablet/image-insure-hero.jpg,
                        /images/detail/tablet/image-insure-hero@2x.jpg,
                        /images/detail/desktop/image-insure-hero.jpg,
                        /images/detail/desktop/image-insure-hero@2x.jpg"
                sizes=""
                src="/images/detail/mobile/image-insure-hero@2x.jpg" alt="Page d'accueil de site web">
        </picture>
    </section>
        <!-- englober les sections dans une section -->
    <main class="container">
        ...
        <article class="argument-content">
            ...
            <div class="argument-illustration">
                <picture>
                    <img srcset="/images/detail/mobile/image-insure-preview-1.jpg,
                                    /images/detail/mobile/image-insure-preview-1@2x.jpg,
                                    /images/detail/tablet/image-insure-preview-1.jpg,
                            ...
                            sizes=""
                            src="/images/detail/mobile/image-insure-preview-1@2x.jpg" alt="Page d'accueil de site web">
                </picture>
            </div>
            <div class="argument-illustration">
                <picture>
                    <img srcset="/images/detail/mobile/image-insure-preview-2.jpg,
                                    /images/detail/mobile/image-insure-preview-2@2x.jpg,
                                    /images/detail/tablet/image-insure-preview-2.jpg,
                            ...
                            sizes=""
                            src="/images/detail/mobile/image-insure-preview-2@2x.jpg" alt="Page de site web version format mobile">
                </picture>
            </div>
        </article> 
